...
const launchSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last Pi client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every Pi client and broker exit; implies persist and disables PTY input",
	),
